...
CREATE TABLE public.screenshot_batches (
    id bigint NOT NULL,
...
ALTER TABLE public.screenshot_batches OWNER TO argos;

--
-- Name: screenshot_batches_id_seq; Type: SEQUENCE; Schema: public; Owner: argos
--

CREATE SEQUENCE public.screenshot_batches_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.screenshot_batches_id_seq OWNER TO argos;

--
-- Name: screenshot_batches_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: argos
--

ALTER SEQUENCE public.screenshot_batches_id_seq OWNED BY public.screenshot_batches.id;
...
ALTER TABLE ONLY public.screenshot_batches ALTER COLUMN id SET DEFAULT nextval('public.screenshot_batches_id_seq'::regclass);
...
ALTER TABLE ONLY public.screenshot_batches
...
CREATE INDEX screenshot_batches_screenshotbucketid_index ON public.screenshot_batches USING btree ("screenshotBucketId");
...
ALTER TABLE ONLY public.screenshot_batches
    ADD CONSTRAINT screenshot_batches_screenshotbucketid_foreign FOREIGN KEY ("screenshotBucketId") REFERENCES public.screenshot_buckets(id);
...
ALTER TABLE ONLY public.screenshots
    ADD CONSTRAINT screenshots_screenshotbatchid_foreign FOREIGN KEY ("screenshotBatchId") REFERENCES public.screenshot_batches(id);
